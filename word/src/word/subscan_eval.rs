...
/// Try to load letter model config from manifest.json next to the checkpoint.
pub fn load_letter_config_from_manifest(cfg: &mut SubScanEvalConfig) {
    ...
    eprintln!("Letter config from {}: {}×{}, latent={}, scan={}, read={}",
